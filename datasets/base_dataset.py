...
class BaseDataset(Dataset): 
    """Base class for datasets.
        ...
        All datasets should subclass it except image dataset which use BaseImageDataset for compability issue. 
...
class BaseImageDataset(Dataset, metaclass=ABCMeta):
    """Base class for datasets.

    All image datasets should subclass it.
    All subclasses should overwrite:
    ...
    def __getitem__(self, idx):
        ...
        if datas['data'].shape[-1] == 3: 
            datas['data'] = datas['data'].transpose([2, 0, 1])
        datas['index'] = idx
        return datas
